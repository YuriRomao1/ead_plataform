 ...
 *
 * This keeps controllers focused on request orchestration and prevents internal
 * exception details from leaking to API clients.
 */
...
public class GlobalExceptionHandler {
	...
	private static final Map<String, String> ERROR_MESSAGES = Map.of(
			...
			"USER_EMAIL_INVALID", "Email must be valid.",
			"USER_PASSWORD_REQUIRED", "Password is required.",
			"USER_ROLE_REQUIRED", "At least one role is required.",
			"USER_ROLE_INVALID", "Role is invalid.",
			UserEmailAlreadyExistsException.CODE, "Email already exists.",
